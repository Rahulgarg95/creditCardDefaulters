...
class Raw_Data_validation:
    ...
    def valuesFromSchema(self):
        ...
        try:
            if not self.dbObj.isCollectionPresent('creditCardDefaultersDB', 'train_schema'):
                with open(self.schema_path, 'r') as f:
                    dic = json.load(f)
                    f.close()
                self.dbObj.insertOneRecord('creditCardDefaultersDB', 'train_schema', dic)
            dic = self.dbObj.getRecords('creditCardDefaultersDB', 'train_schema')
