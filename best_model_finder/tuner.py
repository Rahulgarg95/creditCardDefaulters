...
class Model_Finder:
    ...
    def get_best_params_for_naive_bayes(self,train_x,train_y):
        ...
        try:
            ...
            self.grid = GridSearchCV(estimator=self.gnb, param_grid=self.param_grid, cv=3,  verbose=3, scoring='roc_auc', n_jobs=-1)
    ...
    def get_best_params_for_svc(self,train_x,train_y):
        ...
        try:
            ...
            #Creating an object of the Grid Search class
            self.grid = GridSearchCV(estimator=self.svc, param_grid=self.param_grid, cv=5, verbose=3, n_jobs=-1, scoring='roc_auc')
            #finding the best parameters
            self.grid.fit(train_x, train_y)
    ...
    def get_best_params_for_logistic_reg(self,train_x,train_y):
        ...
        try:
            ...
            #Creating an object of the Grid Search class
            self.grid = GridSearchCV(estimator=self.logreg, param_grid=self.param_grid, cv=5,  verbose=3, n_jobs=-1, scoring='roc_auc')
            #finding the best parameters
            self.grid.fit(train_x, train_y)
    ...
    def get_best_params_for_knn(self,train_x,train_y):
        ...
        try:
            ...
            #Creating an object of the Grid Search class
            self.grid = GridSearchCV(estimator=self.knn, param_grid=self.param_grid, cv=5, verbose=3, n_jobs=-1, scoring='roc_auc')
            #finding the best parameters
            self.grid.fit(train_x, train_y)
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        try:
            ...
            #Creating an object of the Grid Search class
            self.grid = GridSearchCV(estimator=self.clf, param_grid=self.param_grid, cv=5, verbose=3, n_jobs=-1, scoring='roc_auc')
            #finding the best parameters
            self.grid.fit(train_x, train_y)
    ...
    def get_best_params_for_xgboost(self,train_x,train_y):
        ...
        try:
            ...
            # Creating an object of the Grid Search class
            self.grid= GridSearchCV(XGBClassifier(objective='binary:logistic'),self.param_grid_xgboost, verbose=3,cv=5, n_jobs=-1, scoring='roc_auc')
            # finding the best parameters
            self.grid.fit(train_x, train_y)
