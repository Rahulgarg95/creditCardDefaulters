...
class Prediction_Data_validation:
    ...
    def valuesFromSchema(self):
        ...
        try:
            if not self.dbObj.isCollectionPresent('creditCardDefaultersDB', 'predict_schema'):
                with open(self.schema_path, 'r') as f:
                    dic = json.load(f)
                    f.close()
                self.dbObj.insertOneRecord('creditCardDefaultersDB', 'predict_schema', dic)
            dic = self.dbObj.getRecords('creditCardDefaultersDB', 'predict_schema')
